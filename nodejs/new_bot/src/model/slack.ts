    ...
    public getEmbeds() {
        return new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '投稿URL', value: `https://${this.team_domain}.slack.com/archives/${this.slack_channel_id}/p${this.timestamp}` },
            )
            .setColor('#ff1493')
            .setTimestamp()
            .setFooter({
                text: 'Slack連携くん license by Lily',
                iconURL: 'https://firebasestorage.googleapis.com/v0/b/room-notify-v2.appspot.com/o/icons%2Fslack.png?alt=media'
            });
    }
}